import type { BuildingUpgradeRow, ClashKingPetEntry } from "./buildingCatalogTypes";
...
export function rowsFromClashKingPetEntry(entry: ClashKingPetEntry) {
